<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageContent tableContent">
    <form action="/123123/index.php?s=/Home/Ruku/add/navTabId/<?php echo CONTROLLER_NAME;?>" class="pageForm" data-toggle="validate">
		   ...
		   <table class="table table-bordered table-hover table-striped table-top"   data-toggle="tabledit">
                <thead>
                    <tr>
                        ...
                        <th title="产品编号"><input type="text" name="index[#index#].name"  type="text"  value="" size="10" data-toggle="lookup" data-url='/123123/index.php?s=/Home/public/chuku/navTabId/<?php echo CONTROLLER_NAME;?>' data-group="index[#index#]" ></th>
