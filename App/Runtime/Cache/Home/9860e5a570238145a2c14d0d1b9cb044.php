...
<link href="/weiling/Public/BJUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(/weiling/Public/images/loginbg/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(/weiling/Public/images/loginbg/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="/weiling/Public/images/logo.png" >
        </div>
        <!--
