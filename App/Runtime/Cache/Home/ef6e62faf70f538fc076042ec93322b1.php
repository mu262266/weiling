     ...
     <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
        ...
        <tbody>
          ...
          <?php else: ?>
		   ...
		   <?php if(display(CONTROLLER_NAME.'/view')){ ?><td><a href="/weiling/index.php?s=/Home/Case/view/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"  data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" data-mask="true" >详细</a></td><?php } ?>
