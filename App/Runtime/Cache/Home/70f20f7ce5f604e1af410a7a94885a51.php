...
<form id="pagerForm" data-toggle="ajaxsearch" action="/weiling/index.php?s=/Home/Chukus" method="post">
        ...
        <div class="bjui-searchBar">
            <label>关键词：</label><input type="text" value="<?php echo ($_REQUEST['keys']); ?>" name="keys" class="form-control" size="12" />
             ...
             <button type="submit"  class="btn-default" data-icon="search">查询</button>
			  ...
			  <?php if(display(CONTROLLER_NAME.'/del')){ ?><span style="float:right;" ><a href="/weiling/index.php?s=/Home/Chukus/del/navTabId/<?php echo CONTROLLER_NAME;?>" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要清理吗？" data-icon="remove">清理</a></span> <?php } ?>
			  <?php if(display(CONTROLLER_NAME.'/outxls')){ ?><span style="float:right;margin-right:5px;"><a href="/weiling/index.php?s=/Home/Chukus/outxls" class="btn btn-blue" data-toggle="doexport" data-confirm-msg="确定要导出吗？" data-icon="arrow-up">导出</a></span><?php } ?>
		</div> 
</form>
...
<td><?php echo ($v["shenhe"]); ?></td>
		   ...
		   <?php if(display(CONTROLLER_NAME.'/view')){ ?><td><a href="/weiling/index.php?s=/Home/Chukus/view/id/<?php echo ($v['id']); ?>/navTabId/<?php echo CONTROLLER_NAME;?>"  data-toggle="dialog" data-width="900" data-height="500" data-id="dialog-mask" data-mask="true" >详细</a></td><?php } ?>
		   </td>
